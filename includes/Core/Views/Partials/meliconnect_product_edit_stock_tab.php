<div class="melicon-product-edit-stock-tab">
    <p class="form-field melicon_general_stock_variation_field">
        ...
        <span class="wrap">
            ...
            <select id="melicon_general_stock_variation_operand" class="input-text wc_input_decimal" name="template[meta][stock_operand]">
            ...
            <input id="melicon_general_stock_variation_amount" class="input-text wc_input_decimal" type="number" name="template[meta][stock_amount]" value="<?php echo esc_attr($stock_amount); ?>" min="0" size="6">
