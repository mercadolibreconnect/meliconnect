...
<div class="melicon-field">
    ...
    <label for="<?php echo  esc_attr($key); ?>" class="melicon-label"><?php echo esc_html($label); ?></label>
</div>

<?php if (!empty($helpText)) : ?>
    <div class="melicon-columns">
        <div class="melicon-column melicon-is-1"></div>
        <div class="melicon-column melicon-is-11 pl-5">
