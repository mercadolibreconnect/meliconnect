...
<div class="melicon-product-edit-general-tab">
    <p class="form-field melicon_general_price_variation_field">
        ...
        <span class="wrap">
            ...
            <select id="melicon_general_price_variation_operand" class="input-text wc_input_decimal" name="template[meta][price_operand]">
            ...
            <input id="melicon_general_price_variation_amount" class="input-text wc_input_decimal" type="number" name="template[meta][price_amount]" value="<?php echo esc_attr($price_amount); ?>" min="0" size="6">
