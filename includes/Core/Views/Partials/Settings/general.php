<style>
    .melicon-image-uploader {
        position: relative;
    }

    .melicon-image-uploader .melicon-file-cta {
    ...
    .melicon-image-uploader .melicon-image-preview {
    ...
    jQuery(document).ready(function($) {
        $('.upload_image_button').click(function(e) {
            ...
            var custom_uploader = wp.media({
                title: '<?php esc_html_e('Select or Upload Media', 'meliconnect'); ?>',
                library: {
                    type: 'image'
                },
                button: {
                    text: '<?php esc_html_e('Select or Upload Media', 'meliconnect'); ?>'
                },
        ...
        $('.melicon-image-uploader').on('click', '.delete-image', function() {
            ...
            uploader.find('.image-name').text("<?php esc_html_e('No image selected', 'meliconnect') ?>");
