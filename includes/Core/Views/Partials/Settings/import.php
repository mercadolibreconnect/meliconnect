						...
						<div id="meliconnect-import-settings-meliconnect-columns" class="meliconnect-columns">
							<div id="import-setting-left-meliconnect-column" class="meliconnect-column">
								...
								<div id="meliconnect-import-product-info">
									<?php
									self::print_setting_select(
										'meliconnect_import_title',
										esc_html__( 'Title', 'meliconnect' ),
										$import_data['meliconnect_import_title'],
										array(
									...
									<?php
									self::print_setting_select(
										'meliconnect_import_stock',
										esc_html__( 'Stock', 'meliconnect' ),
										$import_data['meliconnect_import_stock'],
										array(
											'always'    => esc_html__( 'Always', 'meliconnect' ),
											'on_create' => esc_html__( 'On Create', 'meliconnect' ),
										)
									...
									<?php
									self::print_setting_select(
										'meliconnect_import_price',
										esc_html__( 'Price', 'meliconnect' ),
										$import_data['meliconnect_import_price'],
										array(
											'always'    => esc_html__( 'Always', 'meliconnect' ),
											'on_create' => esc_html__( 'On Create', 'meliconnect' ),
										)
									...
									<?php
									self::print_setting_select(
										'meliconnect_import_variations_as',
										esc_html__( 'Import variations as:', 'meliconnect' ),
										$import_data['meliconnect_import_variations_as'],
										array(
											'One product with variations'                           => esc_html__( 'One Product with Variations', 'meliconnect' ),
											'multiple products' => esc_html__( 'Multiple Products', 'meliconnect' ),
										)
									);
									?>
									...
									<?php
									self::print_setting_select(
										'meliconnect_import_description_to',
										esc_html__( 'Apply description to:', 'meliconnect' ),
										$import_data['meliconnect_import_description_to'],
										array(
											'description' => esc_html__( 'Long Description', 'meliconnect' ),
											'short_description' => esc_html__( 'Short Description', 'meliconnect' ),
										)
									);
									?>
								</div>
