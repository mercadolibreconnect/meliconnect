...
<script>
    jQuery(document).ready(function($) {
        ...
        function toggleExportSettings(isDisabled) {
            if (isDisabled) {
                $('#melicon-export-settings-melicon-columns input, #melicon-export-settings-melicon-columns select, #melicon-export-settings-melicon-columns textarea').prop('disabled', true);
            } else {
                $('#melicon-export-settings-melicon-columns input, #melicon-export-settings-melicon-columns select, #melicon-export-settings-melicon-columns textarea').prop('disabled', false);
            }
        }
