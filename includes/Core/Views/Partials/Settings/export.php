							...
							<div id="export-setting-left-meliconnect-column" class="meliconnect-column">
								...
								<div id="meliconnect-export-product-info">
									...
									self::print_setting_select(
										'meliconnect_export_title',
										esc_html__( 'Title', 'meliconnect' ),
										$export_data['meliconnect_export_title'],
										array(
									...
									<?php
									self::print_setting_select(
										'meliconnect_export_stock',
										esc_html__( 'Stock', 'meliconnect' ),
										$export_data['meliconnect_export_stock'],
										array(
											'always'    => esc_html__( 'Always', 'meliconnect' ),
											'on_create' => esc_html__( 'On Create', 'meliconnect' ),
										)
									...
									<?php
									self::print_setting_select(
										'meliconnect_export_price',
										esc_html__( 'Price', 'meliconnect' ),
										$export_data['meliconnect_export_price'],
										array(
											'always'    => esc_html__( 'Always', 'meliconnect' ),
											'on_create' => esc_html__( 'On Create', 'meliconnect' ),
										)
									...
									<?php
									self::print_setting_select(
										'meliconnect_export_description_to',
										esc_html__( 'Use description:', 'meliconnect' ),
										$export_data['meliconnect_export_description_to'],
										array(
