<div class="melicon-container">
    <div class="melicon-has-text-centered inside">
        <?php if (!empty($meli_listing_id)): ?>
            <!-- To Update Section -->
            <span class="melicon-tag melicon-is-primary melicon-is-medium melicon-mt-3"><?php _e('To Update', 'meliconnect'); ?></span>
            <?php if (!empty($meli_permalink)): ?>
                <div class="melicon-field melicon-m-3">
                    <a class=" melicon-is-size-6 " href="<?php echo esc_url($meli_permalink); ?>" target="_blank">
                        <i class="fas fa-external-link-alt"></i> <?php _e('View on Meli', 'meliconnect'); ?>
                    </a>
                </div>
            <?php endif; ?>
            <div class="melicon-mt-2">
                ...
                <p><strong ><?php _e('Meli Status', 'meliconnect'); ?>:</strong> <span class="melicon-tag melicon-is-primary melicon-is-light"><?php echo esc_html($meli_status); ?></span></p>
            </div>
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <div class="melicon-field">
                    <button type="button" class="melicon-button melicon-is-info" id="melicon_create_template_button"><?php _e('Create Product Template', 'meliconnect'); ?></button>
                </div>
            <?php endif; ?>
        <?php endif; ?>
    </div>
