 ...
 */
define( 'MELICONNECT_VERSION', '1.3.1' );
define( 'MELICONNECT_DATABASE_VERSION', '1.1.0' );
...
register_activation_hook( __FILE__, array( 'Meliconnect\Meliconnect\Core\DatabaseManager', 'meliconnect_update_tables' ) );
